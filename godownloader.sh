#!/bin/sh
set -e
# Code generated by godownloader on 2019-12-08T21:40:41Z. DO NOT EDIT.
#

usage() {
  this=$1
  cat <<EOF
$this: download go binaries for n8225/awesome-selfhosted-gen

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/n8225/Awesome-Selfhosted-Gen/releases
