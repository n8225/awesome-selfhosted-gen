...
func ImportYaml(ght string) (l parse.List) {
	...
	l.TagIDs = parse.MakeTagMap(l.Entries)
	l.TagList = parse.MakeTags(l.TagIDs)
	l.LangIDs = parse.MakeLangs(l.Entries)
	l.LangList = parse.MakeLangList(l.LangIDs)
	l.CatIDs = parse.MakeCatMap(l.Entries)
	l.CatList = parse.MakeCatList(l.CatIDs)
